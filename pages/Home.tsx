  ...
  return (
    <div className="overflow-hidden bg-[#F8FAFC]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center -mt-28 bg-[#0B1E3F] rounded-b-[4rem] overflow-hidden">
        ...
        <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-[#60A5FA] rounded-full mix-blend-overlay filter blur-[120px] opacity-10"></div>
        
        {/* Content */}
        <div className="container mx-auto px-6 relative z-10 text-center pt-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[#3B82F6] text-[10px] font-bold uppercase tracking-widest mb-8 backdrop-blur-sm animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 tracking-tight leading-[1.1] animate-fade-in-up [animation-delay:100ms]">
                ...
                <span className="text-[#3B82F6]"> {lang === 'en' ? 'Grow.' : 'Kobci.'} </span>
            </h1>
            
            <p className="text-lg md:text-2xl text-gray-400 mb-12 leading-relaxed max-w-3xl mx-auto animate-fade-in-up [animation-delay:200ms] font-light">
                {lang === 'en' 
                ? `${COMPANY_NAME} simplifies complexities. We provide next-generation solutions for businesses ready to scale in East Africa.`
                : `${COMPANY_NAME} waxay fududeyneysaa waxyaabaha adag. Waxaan bixinaa xalal casri ah ganacsiyada u diyaar ah inay koraan.`}
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up [animation-delay:300ms]">
                <Link to="/contact" className="bg-[#3B82F6] text-white font-bold text-sm px-8 py-4 rounded-full transition-all hover:bg-white hover:text-[#0B1E3F] hover:scale-105 flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
      ...
      <section className="py-32 relative">
         <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div>
                    <h2 className="text-4xl md:text-6xl font-bold text-[#0B1E3F] tracking-tight mb-6">
                ...
                <Link to="/services" className="text-[#0B1E3F] font-bold border-b-2 border-[#0B1E3F] pb-1 hover:text-[#3B82F6] hover:border-[#3B82F6] transition-colors">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {services.slice(0, 6).map((service) => {
                     ...
                     return (
                        ...
                        >
                            <div className="w-14 h-14 bg-[#0B1E3F]/5 rounded-2xl flex items-center justify-center text-[#0B1E3F] mb-8 group-hover:bg-[#3B82F6] group-hover:text-white transition-colors duration-500">
                                <Icon size={28} />
                            </div>
                            <h3 className="text-2xl font-bold text-[#0B1E3F] mb-4">{service.title[lang]}</h3>
         ...
         <div className="container mx-auto bg-[#0B1E3F] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                ...
                <p className="text-xl text-gray-400">
                    {lang === 'en' ? `Join hundreds of successful companies trusting ${COMPANY_NAME}.` : `Ku biir boqolaal shirkadood oo guuleystay oo aaminsan ${COMPANY_NAME}.`}
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <Link to="/contact" className="bg-[#3B82F6] text-white font-bold px-10 py-4 rounded-full hover:bg-white hover:text-[#0B1E3F] transition-all shadow-lg hover:shadow-xl">
