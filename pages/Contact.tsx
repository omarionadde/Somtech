  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen relative">
      ...
      <div className="absolute inset-0 bg-[#0B1E3F] z-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-[#60A5FA] rounded-full filter blur-[150px] opacity-10 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10 pt-20 pb-20">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 text-white">
                <span className="text-[#3B82F6] font-bold tracking-widest uppercase text-xs mb-6 block">
                    {lang === 'en' ? 'Get In Touch' : 'Nala Soo Xiriir'}
                </span>
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
                    {lang === 'en' ? 'Let’s start a' : 'Aan bilowno'} <br/>
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3B82F6] to-blue-200">{lang === 'en' ? 'conversation.' : 'wada hadal.'}</span>
                </h1>
                <p className="text-blue-100/80 text-xl md:text-2xl mb-12 max-w-lg">
                ...
                <div className="space-y-8">
                     <div className="flex items-start gap-6 group">
                        <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-[#3B82F6] group-hover:text-white transition-all duration-300">
                            <MapPin size={20} />
                        </div>
                        <div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-black/20">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-400 uppercase tracking-wider ml-2">Name</label>
                            <input 
                                name="name" 
                                value={formData.name} 
                                ...
                                className="w-full px-6 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#0B1E3F] outline-none transition-all font-medium text-lg text-[#0B1E3F]" 
                                required 
                            />
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-400 uppercase tracking-wider ml-2">Phone</label>
                            <input 
                                name="phone" 
                    ...
                    <div className="mb-6 space-y-2">
                        <label className="text-sm font-bold text-gray-400 uppercase tracking-wider ml-2">Email</label>
                        <input 
                            name="email" 
                    ...
                    <div className="mb-6 space-y-2">
                         <label className="text-sm font-bold text-gray-400 uppercase tracking-wider ml-2">Subject</label>
                         <div className="relative">
                            <select 
                                name="subject" 
                                value={formData.subject} 
                                onChange={handleChange} 
                                className="w-full px-6 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#0B1E3F] outline-none transition-all font-medium text-lg text-[#0B1E3F] appearance-none cursor-pointer"
                            >
                    ...
                    <div className="mb-8 space-y-2">
                        <label className="text-sm font-bold text-gray-400 uppercase tracking-wider ml-2">Message</label>
                        <textarea 
                            name="message" 
                            ...
                            className="w-full px-6 py-4 rounded-2xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#0B1E3F] outline-none transition-all font-medium text-lg text-[#0B1E3F] resize-none" 
                            required
                        ></textarea>
                    </div>
